...
<body>
    ...
    <div class="about-container">
        ...
        <div class="about-image">
            <img src="../img/IMG-20250403-WA0024.jpg" alt="Tentang Saya">
        </div>
    </div>
</section>
<section id="skills" class="skills-section">
    ...
    <div class="projects">
        <div class="project-card">
            <img src="../img/Flower, sun, beauty😍.jpeg" alt="Keahlian" class="project-image" />
    ...
    <div class="skills" style="margin-top: 30px;">
        ...
        <section id="projects" class="projects-section">
            ...
            <div class="projects">
                <div class="project-card">
                    <img src="../img/Flower, sun, beauty😍.jpeg" alt="Proyek 1" class="project-image" />
                    <div class="project-content">
                ...
                <div class="project-card">
                    <img src="../img/Wallpaper Bunga Senja!.jpeg" alt="Proyek 2" class="project-image" />
                    <div class="project-content">
                ...
                <div class="project-card">
                    <img src="../img/Wallpaper Bunga Senja!.jpeg" alt="Proyek 3" class="project-image" />
                    <div class="project-content">
